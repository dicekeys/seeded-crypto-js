...
interface StaticSealingAndUnsealing {
     ...
     */
    seal(message: BindableToString, seedString: string, derivationOptionsJson: string): PackagedSealedMessage;
     ...
     * unsealingInstructions (also in plaintext).
     */
    sealWithInstructions(message: BindableToString, unsealingInstructions: string, seedString: string, derivationOptionsJson: string): PackagedSealedMessage;
